...
static const TF_TestDescriptor tests[] = {
    ...
    {"rewrite.runtime.test_task_initialization_resets_registry_and_id_allocator", test_task_initialization_resets_registry_and_id_allocator, "exclusive", 30000, "test.runtime.test_task_initialization_resets_registry_and_id_allocator"},
};
