...
static const TF_TestDescriptor tests[] = {
    {"rewrite.compiler.test_sdiss_writer_failure_stops_output", test_sdiss_writer_failure_stops_output, "exclusive", 30000,
     "api.bytecode.disassembly,baseline.legacy.unified.compiler.test_sdiss_writer_failure_stops_output"},
    {"rewrite.compiler.test_sdiss_summary_writer_failure_propagates", test_sdiss_summary_writer_failure_propagates, "exclusive", 30000,
     "baseline.legacy.unified.compiler.test_sdiss_summary_writer_failure_propagates"},
    {"rewrite.compiler.test_sdiss_summary_writer_failure_preserves_verifier_error", test_sdiss_summary_writer_failure_preserves_verifier_error, "exclusive", 30000,
     "baseline.legacy.unified.compiler.test_sdiss_summary_writer_failure_preserves_verifier_error,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_cli_reports_output_failure", test_sdiss_cli_reports_output_failure, "exclusive", 30000,
     "api.entrypoint.sdiss,baseline.legacy.unified.compiler.test_sdiss_cli_reports_output_failure,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_fixture_basic", test_sdiss_fixture_basic, "exclusive", 30000,
     "api.bytecode.disassembly,api.entrypoint.sdiss,baseline.legacy.unified.compiler.test_sdiss_fixture_basic,bytecode.disassembly.header,bytecode.disassembly.item-expression,bytecode.disassembly.malformed,bytecode.disassembly.mnemonic,bytecode.disassembly.operand,bytecode.disassembly.options,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_malformed_fixture_reports_verifier_diagnostic", test_sdiss_malformed_fixture_reports_verifier_diagnostic, "exclusive", 30000,
     "api.bytecode.disassembly,baseline.legacy.unified.compiler.test_sdiss_malformed_fixture_reports_verifier_diagnostic,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_reads_compiler_operand_widths", test_sdiss_reads_compiler_operand_widths, "exclusive", 30000,
     "baseline.legacy.unified.compiler.test_sdiss_reads_compiler_operand_widths,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_lists_and_itemrefs_show_full_operands", test_sdiss_lists_and_itemrefs_show_full_operands, "exclusive", 30000,
     "baseline.legacy.unified.compiler.test_sdiss_lists_and_itemrefs_show_full_operands,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_jump_display_offsets_and_range", test_sdiss_jump_display_offsets_and_range, "exclusive", 30000,
     "api.entrypoint.sdiss,baseline.legacy.unified.compiler.test_sdiss_jump_display_offsets_and_range,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
    {"rewrite.compiler.test_sdiss_legacy_and_v1_headers_report_absolute_offsets", test_sdiss_legacy_and_v1_headers_report_absolute_offsets, "exclusive", 30000,
     "api.entrypoint.sdiss,baseline.legacy.unified.compiler.test_sdiss_legacy_and_v1_headers_report_absolute_offsets,executable.sdiss.command-line,executable.sdiss.errors,executable.sdiss.exit-status,executable.sdiss.input-output,executable.sdiss.persistence"},
