...
static const TF_TestDescriptor tests[] = {
    ...
    {"rewrite.output_contract.quiet_runner.aggregate_failure",
     ...
     "test.output_contract.quiet_runner.aggregate_failure"},
};
