...
static const TF_TestDescriptor tests[] = {
    {"test.compiler.test_pipeline_negative_matrix", test_pipeline_negative_matrix, "exclusive", 30000,
    ...
    {"test.compiler.test_pipeline_ast_budget_subprocess", test_pipeline_ast_budget_subprocess, "exclusive", 30000,
