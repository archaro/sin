...
static const TF_TestDescriptor tests[] = {
    {"test.core.test_find_item_cached_hit_and_negative_cache",
     test_find_item_cached_hit_and_negative_cache, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_find_item_cached_rejects_invalid_names_without_counters",
     test_find_item_cached_rejects_invalid_names_without_counters, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_find_item_cached_relative_invalid_name_preserves_counters",
     test_find_item_cached_relative_invalid_name_preserves_counters, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_find_item_cached_invalidation_on_delete_and_reinsert",
     test_find_item_cached_invalidation_on_delete_and_reinsert, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_find_item_cached_distinguishes_roots",
     test_find_item_cached_distinguishes_roots, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_itemstore_cache_state_is_store_local",
     test_itemstore_cache_state_is_store_local, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_find_item_cached_root_lifecycle_invalidates_entries",
     test_find_item_cached_root_lifecycle_invalidates_entries, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_item_hashtable_resize_preserves_entries_and_count",
     test_item_hashtable_resize_preserves_entries_and_count, "", 30000,
     "api.itemstore.tree-and-values"},
    {"test.core.test_murmur3_32_alignment_and_vectors",
     test_murmur3_32_alignment_and_vectors, "", 30000,
     "api.itemstore.registry-and-lookup"},
    {"test.core.test_itemstore_benchmarks", test_itemstore_benchmarks,
