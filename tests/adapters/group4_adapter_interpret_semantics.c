...
static const TF_TestDescriptor tests[] = {
    {"test.runtime.test_interpret_semantics_golden", test_interpret_semantics_golden, "exclusive", 30000,
    ...
    {"test.runtime.test_interpret_result_semantics", test_interpret_result_semantics, "exclusive", 30000,
     "language.token.tor,language.token.tand,language.token.tnot,api.runtime.interpreter"},
    {"test.runtime.test_runtime_build_list_allocation_failure_consumes_inputs", test_runtime_build_list_allocation_failure_consumes_inputs, "exclusive", 30000,
     "api.common.memory,api.runtime.opcode-handlers"},
    {"test.runtime.test_interpreter_string_literal_allocation_failure_aborts_frame", test_interpreter_string_literal_allocation_failure_aborts_frame, "exclusive", 30000,
     "api.common.memory,api.runtime.opcode-handlers"},
    {"test.runtime.test_interpret_rejects_malformed_bytecode_before_execution", test_interpret_rejects_malformed_bytecode_before_execution, "exclusive", 30000,
     "bytecode.runtime.errors,api.runtime.interpreter,api.runtime.opcode-handlers"},
    {"test.runtime.test_runtime_verification_cache_reuses_fetch_transfer", test_runtime_verification_cache_reuses_fetch_transfer, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_revision_and_failure_contract", test_runtime_verification_cache_revision_and_failure_contract, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_revision_wrap_invalidates", test_runtime_verification_cache_revision_wrap_invalidates, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_revision_token_saturation_bypasses", test_runtime_verification_cache_revision_token_saturation_bypasses, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_topology_token_wrap_and_saturation", test_runtime_verification_cache_topology_token_wrap_and_saturation, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_ownerless_items_bypass", test_runtime_verification_cache_ownerless_items_bypass, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_runtime_verification_cache_isolates_live_itemstores", test_runtime_verification_cache_isolates_live_itemstores, "exclusive", 30000,
    ...
    {"test.runtime.test_runtime_verification_cache_eviction_is_bounded", test_runtime_verification_cache_eviction_is_bounded, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_interpret_baseline_bytecode_safety_in_default_and_strict_modes", test_interpret_baseline_bytecode_safety_in_default_and_strict_modes, "exclusive", 30000,
     "bytecode.runtime.errors,api.runtime.interpreter"},
    {"test.runtime.test_interpret_legacy_and_v1_headers_execute_equivalently", test_interpret_legacy_and_v1_headers_execute_equivalently, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_interpret_legacy_conversion_semantics", test_interpret_legacy_conversion_semantics, "exclusive", 30000,
     "api.runtime.interpreter"},
    {"test.runtime.test_interpret_embedded_code_boundary_lengths", test_interpret_embedded_code_boundary_lengths, "exclusive", 30000,
     "bytecode.encoding.embedded-code,api.runtime.interpreter"},
    {"test.runtime.test_runtime_jump_diagnostic_uses_absolute_header_offset", test_runtime_jump_diagnostic_uses_absolute_header_offset, "exclusive", 30000,
     "api.runtime.opcode-handlers"},
    {"test.runtime.test_runtime_opcode_schema_witnesses", test_runtime_opcode_schema_witnesses, "exclusive", 30000,
