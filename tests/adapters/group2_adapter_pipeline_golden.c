...
static const TF_TestDescriptor tests[] = {
    {"test.compiler.test_pipeline_golden", test_pipeline_golden, "exclusive", 30000,
    ...
    {"test.compiler.test_pipeline_large_local_lookup_duplicate", test_pipeline_large_local_lookup_duplicate, "exclusive", 30000,
