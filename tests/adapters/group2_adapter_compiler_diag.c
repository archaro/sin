...
static const TF_TestDescriptor tests[] = {
    {"test.compiler.test_compiler_diag_pipeline", test_compiler_diag_pipeline, "exclusive", 30000,
    ...
    {"test.compiler.test_compiler_diag_rejects_deep_foreach_with_dedicated_detail", test_compiler_diag_rejects_deep_foreach_with_dedicated_detail, "exclusive", 30000,
    ...
    {"test.compiler.test_compiler_diag_allows_sequential_foreach_hidden_local_reuse", test_compiler_diag_allows_sequential_foreach_hidden_local_reuse, "exclusive", 30000,
     "language.statement.foreach,api.entrypoint.scomp,executable.scomp.command-line,executable.scomp.input-output,executable.scomp.exit-status,executable.scomp.persistence,executable.scomp.errors"},
    {"test.compiler.test_cli_metadata_stdout_stderr_and_status", test_cli_metadata_stdout_stderr_and_status, "exclusive", 30000,
