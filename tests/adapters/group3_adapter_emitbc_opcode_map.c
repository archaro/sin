...
static const TF_TestDescriptor tests[] = {
    {"test.compiler.test_emitbc_libcall_pair_bytes", test_emitbc_libcall_pair_bytes, "", 30000,
     "bytecode.ir.ir_op_libcall,bytecode.opcode.libcall,bytecode.encoding.libcall,bytecode.verifier.libcall-pair"},
    {"test.compiler.test_emitbc_opcode_map", test_emitbc_opcode_map, "exclusive", 30000,
    ...
    {"test.compiler.test_emitbc_lists_and_itemrefs_emission", test_emitbc_lists_and_itemrefs_emission, "exclusive", 30000,
     "bytecode.encoding.item"},
    {"test.compiler.test_emitbc_push_float_immediate_layout", test_emitbc_push_float_immediate_layout, "", 30000,
     "bytecode.ir.ir_op_push_float,bytecode.opcode.push_float,bytecode.encoding.float"},
    {"test.compiler.test_emitbc_push_int_immediate_layout", test_emitbc_push_int_immediate_layout, "", 30000,
     "bytecode.ir.ir_op_push_int,bytecode.opcode.push_int,bytecode.encoding.integer"},
    {"test.compiler.test_emitbc_opcode_map_call_item_deref_alias_layout", test_emitbc_opcode_map_call_item_deref_alias_layout, "exclusive", 30000,
     "test.compiler.test_emitbc_opcode_map_call_item_deref_alias_layout"},
    {"test.compiler.test_emitbc_opcode_map_unsupported_ir_op", test_emitbc_opcode_map_unsupported_ir_op, "exclusive", 30000,
