...
static const TF_TestDescriptor tests[] = {
    {"test.e2e.scomp_cli_contract_matrix", test_scomp_cli_contract_matrix,
     "exclusive", 30000,
    ...
    {"test.e2e.sdiss_cli_contract_matrix", test_sdiss_cli_contract_matrix,
     "exclusive", 30000,
    ...
    {"test.e2e.sin_cli_contract_matrix", test_sin_cli_contract_matrix,
     "exclusive", 30000,
    ...
    {"test.e2e.sconv_cli_contract_matrix", test_sconv_cli_contract_matrix,
     "exclusive", 30000,
