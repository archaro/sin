...
static const TF_TestDescriptor tests[] = {
    {"test.core.test_sin_itemstore_version_policy",
    ...
    {"test.core.test_sin_default_source_root_validation",
     test_sin_default_source_root_validation, "exclusive", 30000,
     "api.entrypoint.sin,executable.sin.command-line,executable.sin.input-output,executable.sin.exit-status,executable.sin.persistence,executable.sin.errors"},
    {"test.runtime.test_sin_boot_frees_aggregate_return_values",
     test_sin_boot_frees_aggregate_return_values, "exclusive", 30000,
     "api.entrypoint.sin,executable.sin.command-line,executable.sin.input-output,executable.sin.exit-status,executable.sin.persistence,executable.sin.errors"},
    {"test.runtime.test_sin_boot_reports_outstanding_runtime_error",
     test_sin_boot_reports_outstanding_runtime_error, "exclusive", 30000,
     "api.entrypoint.sin,executable.sin.command-line,executable.sin.input-output,executable.sin.exit-status,executable.sin.persistence,executable.sin.errors"},
};
