...
static const TF_TestDescriptor tests[] = {
    {"test.runtime.test_libcall_registry_roundtrip",
     test_libcall_registry_roundtrip, "exclusive", 30000,
     "bytecode.encoding.libcall,api.libcall.registry,api.libcall.table,libcall.sys.shutdown,libcall.sys.abort"},
    {"test.runtime.test_runtime_init_validates_libcalls_once",
     test_runtime_init_validates_libcalls_once, "exclusive", 30000,
     "api.runtime.runtime-opcode"},
    {"test.runtime.test_interpret_lazy_init_failure_is_transactional",
     test_interpret_lazy_init_failure_is_transactional, "exclusive", 30000,
     "api.runtime.interpreter,api.runtime.runtime-opcode"},
    {"test.runtime.test_libcall_registry_init_failure_has_no_partial_state",
     test_libcall_registry_init_failure_has_no_partial_state, "exclusive", 30000,
     "api.libcall.registry"},
    {"test.runtime.test_libcall_registry_lifecycle_reinit_sequence",
     test_libcall_registry_lifecycle_reinit_sequence, "exclusive", 30000,
     "test.runtime.test_libcall_registry_lifecycle_reinit_sequence"},
    {"test.runtime.test_libcall_registry_repeated_teardown_is_safe",
     test_libcall_registry_repeated_teardown_is_safe, "exclusive", 30000,
     "test.runtime.test_libcall_registry_repeated_teardown_is_safe"},
    {"test.runtime.test_missing_libcall_is_null_and_interpret_deterministic",
     test_missing_libcall_is_null_and_interpret_deterministic, "exclusive", 30000,
     "test.runtime.test_missing_libcall_is_null_and_interpret_deterministic"},
    {"test.runtime.test_default_libcall_wrappers_lazy_init_after_reset",
     test_default_libcall_wrappers_lazy_init_after_reset, "exclusive", 30000,
     "test.runtime.test_default_libcall_wrappers_lazy_init_after_reset"},
    {"test.runtime.test_libcall_registry_self_check_invalid_entries",
     test_libcall_registry_self_check_invalid_entries, "exclusive", 30000,
     "api.libcall.registry,api.libcall.table"},
    {"test.runtime.test_libcall_invalid_arg_branches_return_contracts",
     test_libcall_invalid_arg_branches_return_contracts, "exclusive", 30000,
     "language.semantic-rule.libcall-resolution"},
    {"test.runtime.test_libcall_float_integer_only_arguments_rejected",
     test_libcall_float_integer_only_arguments_rejected, "exclusive", 30000,
     "test.runtime.test_libcall_float_integer_only_arguments_rejected"},
    {"test.runtime.test_libcall_output_formats_values",
     test_libcall_output_formats_values, "exclusive", 30000,
     "api.common.logging,libcall.sys.log"},
};
