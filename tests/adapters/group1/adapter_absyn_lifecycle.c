...
static const TF_TestDescriptor tests[] = {
    {"test.core.test_absyn_nested_binary_expressions", test_absyn_nested_binary_expressions, "exclusive", 30000,
    ...
    {"test.core.test_absyn_budget_limits_and_iterative_cleanup", test_absyn_budget_limits_and_iterative_cleanup, "exclusive", 30000,
     "test.core.test_absyn_budget_limits_and_iterative_cleanup"},
    {"test.core.test_absyn_stmtlist_multiple_statements", test_absyn_stmtlist_multiple_statements, "exclusive", 30000,
    ...
    {"test.core.test_absyn_if_elsif_else_chain", test_absyn_if_elsif_else_chain, "exclusive", 30000,
     "bytecode.ast.n_whilestmt,bytecode.ast.n_ifstmt,bytecode.ast.n_foreach,bytecode.ast.n_foreachspec"},
    {"test.core.test_absyn_item_deref_chains", test_absyn_item_deref_chains, "exclusive", 30000,
    ...
    {"test.core.test_absyn_float_value_preserves_bits", test_absyn_float_value_preserves_bits, "exclusive", 30000,
     "test.core.test_absyn_float_value_preserves_bits"},
    {"test.core.test_absyn_nil_value_payload_free", test_absyn_nil_value_payload_free, "exclusive", 30000,
     "test.core.test_absyn_nil_value_payload_free"},
    {"test.core.test_absyn_malformed_float_valnode_returns_null", test_absyn_malformed_float_valnode_returns_null, "exclusive", 30000,
     "test.core.test_absyn_malformed_float_valnode_returns_null"},
    {"test.core.test_absyn_constructor_allocation_failures",
     test_absyn_constructor_allocation_failures, "exclusive", 30000,
     "api.common.memory,api.compiler.ast-lifecycle"},
    {"test.core.test_absyn_valnode_string_second_allocation_failure", test_absyn_valnode_string_second_allocation_failure, "exclusive", 30000,
     "test.core.test_absyn_valnode_string_second_allocation_failure"},
    {"test.core.test_absyn_stmtlist_growth_failure_preserves_statement", test_absyn_stmtlist_growth_failure_preserves_statement, "exclusive", 30000,
