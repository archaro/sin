...
static const TF_TestDescriptor tests[] = {
    {"test.core.test_parser_float_literals_decimal_forms", test_parser_float_literals_decimal_forms, "exclusive", 30000,
     "language.token.tfloat,language.literal.float"},
    {"test.core.test_parser_float_literals_integer_still_int", test_parser_float_literals_integer_still_int, "exclusive", 30000,
     "language.token.tinteger"},
    {"test.core.test_parser_float_literals_unary_minus_preserves_float_literals", test_parser_float_literals_unary_minus_preserves_float_literals, "exclusive", 30000,
     "language.token.tminus"},
    {"test.core.test_parser_float_literals_item_layers_unchanged", test_parser_float_literals_item_layers_unchanged, "exclusive", 30000,
     "test.core.test_parser_float_literals_item_layers_unchanged"},
    {"test.core.test_parser_float_literals_malformed_rejected", test_parser_float_literals_malformed_rejected, "exclusive", 30000,
     "language.token.tfloat,language.literal.float,language.diagnostic.lexer-error"},
    {"test.core.test_parser_integer_literals_range", test_parser_integer_literals_range, "exclusive", 30000,
     "language.token.tinteger,language.literal.integer"},
    {"test.core.test_floatconv_binary64_edge_cases",
     test_floatconv_binary64_edge_cases, "", 30000,
     "api.common.float-format"},
    {"test.core.test_floatconv_binary64_formatting",
     test_floatconv_binary64_formatting, "", 30000,
     "api.common.float-format"},
    {"test.core.test_floatconv_binary64_format_roundtrip",
