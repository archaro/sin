...
static const TF_TestDescriptor tests[] = {
    {"test.core.test_parser_input_api", test_parser_input_api, "exclusive", 30000,
    ...
    {"test.core.test_parser_compound_spans_preserve_construct_start", test_parser_compound_spans_preserve_construct_start, "exclusive", 30000,
     "test.core.test_parser_compound_spans_preserve_construct_start"},
    {"test.core.test_parser_ast_node_budget_stops_construction_early", test_parser_ast_node_budget_stops_construction_early, "exclusive", 30000,
     "test.core.test_parser_ast_node_budget_stops_construction_early"},
    {"test.core.test_parser_lists_and_itemrefs_ast", test_parser_lists_and_itemrefs_ast, "exclusive", 30000,
    ...
    {"test.core.test_parser_foreach_ast", test_parser_foreach_ast, "exclusive", 30000,
    ...
    {"test.core.test_parser_scanner_setup_allocation_failures",
     test_parser_scanner_setup_allocation_failures, "exclusive", 30000,
     "api.common.memory"},
    {"test.core.test_parser_cleanup_allocation_failures",
    ...
    {"test.core.test_parser_foreach_allocation_failures", test_parser_foreach_allocation_failures, "exclusive", 30000,
