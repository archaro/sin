...
LIB_OBJECTS := $(OBJ_DIR)/common/log.o $(OBJ_DIR)/common/memory.o $(OBJ_DIR)/common/cli_io.o \
 ...
 $(OBJ_DIR)/libcall/libcall_str.o $(OBJ_DIR)/libcall/libcall_list.o $(OBJ_DIR)/libcall/libcall_math.o $(OBJ_DIR)/libcall/libcall_rand.o $(OBJ_DIR)/libcall/libcall_time.o $(OBJ_DIR)/libcall/libcall_text.o $(OBJ_DIR)/libcall/libcall_registry.o \
 $(OBJ_DIR)/libcall/libcall_conv.o \
